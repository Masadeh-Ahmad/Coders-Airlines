...
namespace Coders_Airlines.Migrations
{
    ...
    [Migration("20220719185545_ThreeApartment")]
    partial class ThreeApartment
    {
            ...
            modelBuilder.Entity("Coders_Airlines.Models.Apartment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            City = "Amman",
                            Description = "Three bedrooms and two pathrooms with full view of Apdalli Towers in the middle of Amman",
                            IsAvailable = true,
                            RentalCost = 500.0
                        },
                        new
                        {
                            ID = 2,
                            City = "Amman",
                            Description = "Two master bedrooms and two teraes in the DownTowm of Amman",
                            IsAvailable = true,
                            RentalCost = 700.0
                        },
                        new
                        {
                            ID = 3,
                            City = "Paris",
                            Description = "Four bedrooms, two of them are masters and two indivisual pathrooms with full view of Evil Tower in the middle of Paris",
                            IsAvailable = true,
                            RentalCost = 1500.0
                        });
                });
